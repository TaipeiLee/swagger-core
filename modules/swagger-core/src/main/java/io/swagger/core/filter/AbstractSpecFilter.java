...
public abstract class AbstractSpecFilter implements OpenAPISpecFilter {
    ...
    @Override
    public Optional<Schema> filterSchemaProperty(Schema property, Schema schema, Map<String, List<String>> params, Map<String, String> cookies, Map<String, List<String>> headers) {
